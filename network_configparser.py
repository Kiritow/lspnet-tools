...
def get_bird_config(router_id, direct_interface_names, ospf_exclude_import_cidrs, ospf_exclude_export_cidrs, ospf_area_config):
    ...
    localnet_no_import_variable_text = ','.join(ospf_exclude_import_cidrs)
    localnet_no_export_variable_text = ','.join(ospf_exclude_export_cidrs)
...
prefix set LOCALNET_NO_IMPORTSET;
prefix set LOCALNET_NO_EXPORTSET;

LOCALNET_NO_IMPORTSET=[{localnet_no_import_variable_text}];
LOCALNET_NO_EXPORTSET=[{localnet_no_export_variable_text}];
